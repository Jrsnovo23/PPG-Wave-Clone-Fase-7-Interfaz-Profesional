...
/**
    Editor de la Fase 7: interfaz profesional definitiva — LookAndFeel
    propio (paneles oscuros, knobs con arco de valor, acentos cian/ámbar),
    paneles agrupados visualmente, visualización gráfica ADSR en las dos
    envolventes, indicador de actividad MIDI, y una ventana notablemente
    más compacta que las fases anteriores (misma cantidad de controles,
    presentados con más densidad).
    ...
    - Sync (on/off) y Retrigger de cada LFO, y Delay Sync/Sync Division,
      ...
      compactos.
    - Sección de Vintage Character: no existe todavía (esa es la Fase 8,
      pendiente) — cuando se implemente, se agrega como un panel más
      siguiendo el mismo patrón que el resto.
*/
