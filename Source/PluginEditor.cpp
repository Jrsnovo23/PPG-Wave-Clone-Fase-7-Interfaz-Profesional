    ...
    : AudioProcessorEditor (&p), processorRef (p)
{
    ...
    titleLabel.setText ("PPG WAVE CLONE - Fase 7", juce::dontSendNotification);
...
void PPGWaveCloneAudioProcessorEditor::resized()
{
    ...
    masterVolumeSlider.setBounds (masterArea.withSizeKeepingCentre (56, 50).translated (0, -6));
    masterVolumeLabel.setBounds (masterArea.removeFromBottom (14));
